...
return {
     ...
     ruta_deshacer: function(pk){
        return 'compras_detalles/desvalidar/' + pk + '/';
     },
    ...
    Deshacer: function(id,funcion_exito,funcion_error){
      var compra_det = new ModeloBase({
              id: id 
          });

      compra_det.asignarRuta(this.ruta_deshacer(id));
